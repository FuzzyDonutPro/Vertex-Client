...
public final class RenderUtil {
    ...
    public static void beginWorldRender(WorldRenderContext context) {
    ...
    public static void drawAABB(AABB box, Color color, boolean filled) {
        ...
        if (filled) {
            activeNodeCollector.submitCustomGeometry(activePoseStack, RenderTypes.debugFilledAABB(), (pose, consumer) -> {
                addFilledAABBVertices(consumer, pose, box, r, g, b, a);
            });
        } else {
            activeNodeCollector.submitCustomGeometry(activePoseStack, RenderTypes.lines(), (pose, consumer) -> {
                addOutlineAABBVertices(consumer, pose, box, r, g, b, a);
            });
        }
    }
