...
public class CommissionMacro extends AbstractMacro {
    private static final long PENDING_COMMISSION_VALIDATION_TIMEOUT_MS = 2000L;
    private static final long CHAT_CLAIM_GUARD_TIMEOUT_MS = 20000L;
    ...
    public void onTablistUpdate(UpdateTablistEvent event) {
        ...
        if (pendingCommission != null) {
            ...
            log("Pending commission mismatch. GUI suggested " + pendingCommission.getName() + ", tablist says " + tablistCommission.getName() + ". Switching to tablist target.");
            clearPendingCommission();
            setCurrentCommission(tablistCommission);
            return;
        }
    ...
    public static CommissionMacro getInstance() {
        return CommissionMacro.instance;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CommissionMacroState getCurrentState() {
        return this.currentState;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public int getActualCommissionCounter() {
        return this.actualCommissionCounter;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public long getTotalHotmXP() {
        return this.totalHotmXP;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setCurrentCommission(final Commission currentCommission) {
        this.currentCommission = currentCommission;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Commission getPendingCommission() {
        return this.pendingCommission;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public long getLastCommissionCompleteAtMs() {
        return this.lastCommissionCompleteAtMs;
    }
}
