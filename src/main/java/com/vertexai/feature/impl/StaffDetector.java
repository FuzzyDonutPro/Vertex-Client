...
/**
 * StaffDetector — Detects Hypixel Staff, Admins, and Watchdog bots in current lobby.
...
public class StaffDetector extends AbstractFeature {
    ...
    private void evacuateLobby(String staffName) {
        ...
        DiscordWebhookNotifier.sendWebhookNotification("🚨 STAFF DETECTED", "Hypixel Staff/Admin `" + staffName + "` detected in lobby! Macro terminated and evacuated to hub.", 0xFFDC2626);
