...
import com.vertexai.command.graph.GraphCommand;
import com.vertexai.command.graph.GraphCommandRegistrar;
...
public class CommandManager {
    ...
    public void registerAll() {
        ClientCommandRegistrationCallback.EVENT.register(
                (dispatcher, registryAccess) -> {
                    ...
                    registerVertexCommand(dispatcher, "fz", openConfigAction);
                }
        );
    }
    ...
    private void registerVertexCommand(
            CommandDispatcher<FabricClientCommandSource> dispatcher,
            String root,
        ...
        dispatcher.register(
                literal(root)
                        ...
                        .then(buildGotoCommand())
        );
    }

    private LiteralArgumentBuilder<FabricClientCommandSource> buildGotoCommand() {
        return literal("goto")
                .then(
                        argument("x", IntegerArgumentType.integer())
                                .then(
    ...
    private void registerReactionCommand(CommandDispatcher<FabricClientCommandSource> dispatcher) {
            ...
            literal("reaction")
                ...
                .then(literal("record")
                    .then(argument("name", StringArgumentType.word())
                        .executes(context -> {
                            cmd.record(StringArgumentType.getString(context, "name"), 200);
                            return 1;
                        })
                ...
                .then(literal("play").then(argument("name", StringArgumentType.greedyString()).executes(context -> {
                    cmd.play(StringArgumentType.getString(context, "name"));
                    return 1;
                })))
                ...
                .then(literal("delete").then(argument("name", StringArgumentType.greedyString()).executes(context -> {
                    cmd.delete(StringArgumentType.getString(context, "name"));
                    return 1;
                })))
        );
    }
