...
public class TablistUtil {
    ...
    public static void update() {
        ...
        try {
            Component header = ((PlayerListHudAccessor) mc.gui.hud.getTabList()).Vertex$getHeader();
            if (header != null) {
        ...
        try {
            Component footer = ((PlayerListHudAccessor) mc.gui.hud.getTabList()).Vertex$getFooter();
            if (footer != null) {
    ...
    static class PlayerComparator implements Comparator<PlayerInfo> {
        ...
        public int compare(PlayerInfo o1, PlayerInfo o2) {
            ...
            return ComparisonChain.start().compareTrueFirst(
                    ...
                    .compare(o1.getProfile().getName(), o2.getProfile().getName()).result();
        }
    }
}
