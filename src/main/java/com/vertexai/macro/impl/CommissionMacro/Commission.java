...
//  STAR_CENTRY_SLAYER("Star Sentry Puncher	"),
    ...
    private static RouteWaypoint selectBestWaypoint(Collection<RouteWaypoint> candidates) {
        ...
        return candidates.stream()
                .min(Comparator
                        .comparingInt((RouteWaypoint waypoint) -> countNearbyRealPlayers(waypoint.toVec3(), avoidRadiusSq))
                        .thenComparingDouble(waypoint -> waypoint.toVec3().distanceToSqr(playerPos)))
