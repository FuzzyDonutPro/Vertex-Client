...
import com.vertexai.util.render.VFRenderLayers;
...
public final class RenderUtil {
    ...
    private static MultiBufferSource activeMultiBufferSource;
    ...
    private static void drawSimpleWorldLine(Vec3 start, Vec3 end, Color color) {
        drawRibbonSegment(start, end, color, 0.03f, com.vertexai.util.render.VFRenderLayers.QUADS_DEPTH);
    }
    ...
    private static void drawNoDepthDebugLine(Vec3 start, Vec3 end, Color color) {
        drawRibbonSegment(start, end, color, 0.03f, com.vertexai.util.render.VFRenderLayers.QUADS_NO_DEPTH);
    }
    ...
    public static void drawText(String text, double x, double y, double z, float scale) {
        ...
        mc.font.drawInBatch(
                orderedText, textX, textY,
                0xFFFFFFFF,
                false,
                activePoseStack.last().pose(),
                activeMultiBufferSource,
