...
public class ItemChangeFailsafe extends AbstractFailsafe {
    ...
    public boolean onPacketReceive(Packet<?> packet) {
        ...
        if (!(packet instanceof ClientboundContainerSetSlotPacket)) (ERROR);
        {
            return false;
        }
        int slot = p.getSlot();
        ...
        List<String> necessaryDisplayNames = MacroManager.getInstance().getCurrentMacro().getNecessaryItems().stream().filter(name -> name != null && !name.isEmpty()).collect(Collectors.toList());
    ...
    public static ItemChangeFailsafe getInstance() {
        return ItemChangeFailsafe.instance;
    }
}
