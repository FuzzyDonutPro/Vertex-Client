...
public class BadEffectFailsafe extends AbstractFailsafe {
    ...
    private final Set<Holder<MobEffect>> BAD_EFFECTS = ImmutableSet.of(MobEffects.POISON, MobEffects.WITHER, MobEffects.WEAKNESS, MobEffects.BLINDNESS, MobEffects.HUNGER, MobEffects.SLOWNESS, MobEffects.MINING_FATIGUE);
