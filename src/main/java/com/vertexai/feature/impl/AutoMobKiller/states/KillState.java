...
public class KillState implements AutoMobKillerState {
    ...
    public AutoMobKillerState onTick(AutoMobKiller mobKiller) {
        ...
        boolean aimAlignedOnMob = (mc.hitResult instanceof EntityHitResult hit 
                ...
                || (hasLineOfSight && Math.abs(com.vertexai.util.AngleUtil.getNeededYawChange(mc.player.getYRot(), com.vertexai.util.AngleUtil.getRotationYaw(mobKiller.getTargetMob().getEyePosition(1.0f)))) < 45.0f);
