...
public class DebugCommand {
    ...
    public void nbt() {
        ...
        out.append("=== Vertex Held Item NBT Dump ===\n");
        ...
        out.append("=== End Vertex Held Item NBT Dump ===");
    ...
    public void location() {
        ...
        Logger.sendMessage("Location: " + location.getName() + " (" + location.getName() + ")");
    ...
    public void sublocation() {
        ...
        Logger.sendMessage("SubLocation: " + subLocation.getName() + " (" + subLocation.getName() + ")");
    }
    ...
    public void where() {
        ...
        Logger.sendLog("Location: " + location.getName() + " (" + location.getName() + ")"
                + " | SubLocation: " + subLocation.getName() + " (" + subLocation.getName() + ")");
    }
    ...
    public void scoreboardDump() {
        ...
        StringBuilder out = new StringBuilder(4096);
        out.append("=== Vertex Sidebar Scoreboard Dump ===\n");
        ...
        out.append("=== End Vertex Sidebar Scoreboard Dump ===");
    ...
    public void state() {
        GameStateHandler handler = GameStateHandler.getInstance();
        Logger.sendMessage("Location: " + handler.getCurrentLocation().getName());
        Logger.sendMessage("SubLocation: " + handler.getCurrentSubLocation().getName());
    ...
    public void fishingStage() {
        ...
        Logger.sendMessage("Location: " + handler.getCurrentLocation().getName()
                + " | SubLocation: " + handler.getCurrentSubLocation().getName());
    ...
    public void mineHere(Integer overrideSpeed) {
        ...
        miner.setWaitThreshold(com.vertexai.Vertex.config().general.oreRespawnWaitThreshold * 1000);
        miner.start(blocksToMine, speed, ability, mithrilPriority, com.vertexai.Vertex.config().general.miningTool);

        Logger.sendMessage("Started mine-here test: mithril+titanium in current area.");
        Logger.sendMessage("Speed=" + speed + ", Ability=" + ability.getName() + ", WaitThresholdMs=" + (com.vertexai.Vertex.config().general.oreRespawnWaitThreshold * 1000));
    }
    ...
    public void slayerStatus() {
        AutoMobKiller killer = AutoMobKiller.getInstance();
        Logger.sendMessage("Slayer debug status: running=" + killer.isRunning() + ", state=" + killer.getCurrentStateName() + ", error=" + killer.getError().getName() + ", blacklist=" + killer.getBlacklistedMobs().size());
    ...
    public void slayerStart(String targetKey) {
        ...
        String weapon = commission == Commission.GLACITE_WALKER_SLAYER
                ...
                : Vertex.config().commission.dwarvenCommission.slayerWeapon;
    ...
    public void pathDwarven(String targetKey, boolean renderOnly) {
        ...
        RouteWaypoint target = Arrays.stream(candidates)
                .min(Comparator.comparingDouble(it -> it.toVec3().distanceTo(mc.player.position())))
                .orElse(null);
