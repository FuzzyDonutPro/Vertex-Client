...
public class AutoWarp extends AbstractFeature {
    ...
    private final Set<String> waitMessages = ImmutableSet.of("Couldn\'t warp you! Try again later.", "Cannot join SkyBlock for a moment!", "You are sending commands too fast! Please slow down.", "You were kicked while joining that server!", "You tried to rejoin too fast, please try again in a moment.");
