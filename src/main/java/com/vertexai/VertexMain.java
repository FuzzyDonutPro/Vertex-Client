...
/**
 * Static utility class for VertexMain.
...
public class VertexMain {
    ...
    private static ThreadPoolExecutor createExecutor() {
        ...
        RejectedExecutionHandler rejectedExecutionHandler = (runnable, exec) -> {
            ...
            Logger.sendWarning("VertexMain executor saturated; running task on calling thread");
            LOGGER.warn("VertexMain executor saturated; running task on calling thread");
            runnable.run();
        };
    ...
    public static void loadRoutes() {
        ...
        for (String file : expectedRoutes) {
            ...
            try (InputStream in = VertexMain.class.getResourceAsStream("/vertexai/" + file)) {
                if (in == null) {
