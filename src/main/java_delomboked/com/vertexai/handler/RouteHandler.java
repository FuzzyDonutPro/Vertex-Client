...
public class RouteHandler {
    ...
    public void loadData() {
        ...
        try (Reader reader = Files.newBufferedReader(Vertex.routesFile)) {
            ...
            JsonElement routesElement = jsonObject.has("routes") ? jsonObject.get("routes") : jsonObject;
            if (routesElement == null || routesElement.isJsonNull()) {
                throw new IllegalStateException("routes.json does not contain routes");
            }
            HashMap<String, Route> loadedRoutes = Vertex.gson.fromJson(routesElement, new TypeToken<HashMap<String, Route>>() {
            }.getType());
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public long getLastDirtyAtMs() {
        return this.lastDirtyAtMs;
    }
}
