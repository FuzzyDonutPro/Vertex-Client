package com.vertexai.macro.impl.CommissionMacro;
...
public class CommissionMacro extends AbstractMacro {
    ...
    public List<String> getNecessaryItems() {
        ...
        items.add(Vertex.config().commission.dwarvenCommission.slayerWeapon);

        if (Vertex.config().commission.dwarvenCommission.commClaimMethod == 1) {
