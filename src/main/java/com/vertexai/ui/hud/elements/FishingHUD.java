...
public class FishingHUD extends TextHud {
   ...
   protected void getLines(List<String> lines, boolean example) {
      ...
      if (state instanceof FishingKillingState killingState) {
         ...
         lines.add("§8» §7Waiting for Killing state...");
      }
   }
