...
public final class VFRenderPipelines {
    ...
    public static final RenderPipeline QUADS_DEPTH = RenderPipelines.register(
            RenderPipeline.builder()
                    ...
                    .withCull(false)
                    .withLocation(Identifier.fromNamespaceAndPath("Vertex", "pipeline/quads_depth"))
                    .build()
    );
    ...
    public static final RenderPipeline QUADS_NO_DEPTH = RenderPipelines.register(
            RenderPipeline.builder()
                    ...
                    .withCull(false)
                    .withLocation(Identifier.fromNamespaceAndPath("Vertex", "pipeline/quads_no_depth"))
                    .build()
    );
    ...
    public static final RenderPipeline LINES_NO_DEPTH = RenderPipelines.register(
            RenderPipeline.builder()
                    ...
                    .withDepthStencilState(new DepthStencilState(CompareOp.ALWAYS_PASS, false))
                    .withCull(false)
                    .withLocation(Identifier.fromNamespaceAndPath("Vertex", "pipeline/lines_no_depth"))
                    .build()
    );
    ...
    public static final RenderPipeline LINES_DEPTH = RenderPipelines.register(
            RenderPipeline.builder()
                    ...
                    .withDepthStencilState(new DepthStencilState(CompareOp.LESS_THAN_OR_EQUAL, false))
                    .withCull(false)
                    .withLocation(Identifier.fromNamespaceAndPath("Vertex", "pipeline/lines_depth"))
                    .build()
    );
