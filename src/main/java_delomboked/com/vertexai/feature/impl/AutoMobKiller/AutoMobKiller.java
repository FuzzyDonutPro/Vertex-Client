...
public class AutoMobKiller extends AbstractFeature {
    ...
    public enum SlayerProfile {
        GENERIC(null), GOBLIN(new BlockPos(-134, 143, 142)), GLACITE(new BlockPos(5, 127, 143));
        ...
        public boolean isTargetInPreferredZone(LivingEntity entity) {
            ...
            switch (this) {
            case GOBLIN: 
                return y > 127.0 && (z <= 153.0 || x >= -157.0) && (z >= 148.0 || x <= -77.0);
            case GLACITE: 
                return y >= 127.0 && y <= 132.0 && z >= 147.0 && z <= 180.0 && x <= 42.0;
            case GENERIC: 
            default: 
                return true;
            }
    ...
    @lombok.Generated
    public Set<String> getMobsToKill() {
        return this.mobsToKill;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public MKError getError() {
        return this.error;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setError(final MKError error) {
        this.error = error;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public SlayerProfile getSlayerProfile() {
        return this.slayerProfile;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setSlayerProfile(final SlayerProfile slayerProfile) {
        this.slayerProfile = slayerProfile;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setTargetMob(final LivingEntity targetMob) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Vec3 getTargetMobOriginalPos() {
        return this.targetMobOriginalPos;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setTargetMobOriginalPos(final Vec3 targetMobOriginalPos) {
        this.targetMobOriginalPos = targetMobOriginalPos;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setPathAttempts(final int pathAttempts) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Set<LivingEntity> getBlacklistedMobs() {
        return this.blacklistedMobs;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setBlacklistedMobs(final Set<LivingEntity> blacklistedMobs) {
