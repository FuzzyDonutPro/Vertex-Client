...
public class RouteBuilderCommand {
    ...
    public void select(final String routeName) {
        ...
        Vertex.config().routeMiner.selectedRoute = normalized;
    ...
    public void add(final String name) {
        ...
        if (RouteBuilder.getInstance().addToRoute(type)) {
            Logger.sendMessage("Added " + type.getName().charAt(0) + type.getName().substring(1).toLowerCase());
        }
    }
    ...
    public void replace(final int indexToReplace, final String name) {
        ...
        Logger.sendMessage("Replaced index " + indexToReplace + " with " + type.getName().charAt(0) + type.getName().substring(1).toLowerCase());
    }
