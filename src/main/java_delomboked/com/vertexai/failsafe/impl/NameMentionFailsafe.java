...
public class NameMentionFailsafe extends AbstractFailsafe {
    ...
    @lombok.Generated
    public static NameMentionFailsafe getInstance() {
        return NameMentionFailsafe.instance;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public boolean isLobbyChangeRequested() {
        return this.lobbyChangeRequested;
    }
}
