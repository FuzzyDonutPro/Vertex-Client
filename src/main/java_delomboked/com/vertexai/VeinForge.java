...
import com.vertexai.util.helper.graph.*;
...
/**
 * Static utility class for Vertex.
 * Entry point is now VertexClient.
 */
public class Vertex {

    public static final String MOD_ID = "Vertex";
    ...
    private static ThreadPoolExecutor createExecutor() {
        ...
        RejectedExecutionHandler rejectedExecutionHandler = (runnable, exec) -> {
            ...
            Logger.sendWarning("Vertex executor saturated; running task on calling thread");
            LOGGER.warn("Vertex executor saturated; running task on calling thread");
            runnable.run();
        };
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(
                ...
                runnable -> {
                    ...
                    thread.setName("Vertex-worker-" + threadId.getAndIncrement());
    ...
    public static void loadRoutes() {
        ...
        for (String file : expectedRoutes) {
            ...
            try (InputStream in = Vertex.class.getResourceAsStream("/Vertex/" + file)) {
                if (in == null) {
