...
public class PathExecutor {
    ...
    public boolean onTick() {
        ...
        boolean closeToCurrentNode = horizontalDistToCurrent <= NODE_REACHED_HORIZONTAL_DIST && verticalDistToCurrent <= NODE_REACHED_VERTICAL_TOLERANCE;
        ...
        if (yawDiff > 3 && !RotationHandler.getInstance().isEnabled()) {
            ...
            RotationHandler.getInstance().easeTo(new RotationConfiguration(new Angle(rotYaw, (float) lastPitch), (long) time, null));
        }
    ...
    private boolean shouldAvoidForwardMovement(float yaw, BlockPos playerPos) {
        ...
        BlockPos ahead = BlockPos.containing(mc.player.getX() + forward.x * COLLISION_CHECK_DISTANCE, playerPos.getY(), mc.player.getZ() + forward.z * COLLISION_CHECK_DISTANCE);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setAllowInterpolation(final boolean allowInterpolation) {
