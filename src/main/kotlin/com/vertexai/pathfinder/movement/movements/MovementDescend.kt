...
class MovementDescend(mm: VertexMain, from: BlockPos, to: BlockPos) : Movement(mm, from, to) {
...
//                ctx.cost.WALK_OFF_ONE_BLOCK_COST * ctx.cost.SPRINT_MULTIPLIER + ctx.cost.N_BLOCK_FALL_COST[1]
        ...
        fun freeFallCost(
            ...
            for (fellSoFar in 2..Int.MAX_VALUE) {
                ...
                val penalty = unprotectedFallHeight * 2.0
                val costUpUntilThisBlock =
                    ctx.cost.WALK_OFF_ONE_BLOCK_COST + ctx.cost.N_BLOCK_FALL_COST[unprotectedFallHeight] + cost + penalty
