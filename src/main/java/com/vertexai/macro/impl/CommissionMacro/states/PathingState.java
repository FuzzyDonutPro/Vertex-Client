...
public class PathingState implements CommissionMacroState {
    ...
    public void onStart(CommissionMacro macro) {
        ...
        if ((commission == Commission.COMMISSION_CLAIM && Vertex.config().commission.dwarvenCommission.commClaimMethod == 1)
        ...
        if (!isInTargetLocation && distFromForge + 10 < distFromPlayer && Vertex.config().commission.dwarvenCommission.forgePathing) {
