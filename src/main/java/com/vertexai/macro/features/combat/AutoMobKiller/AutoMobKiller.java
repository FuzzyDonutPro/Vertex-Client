package com.vertexai.macro.features.combat.AutoMobKiller;

import lombok.Getter;
import lombok.Setter;
import com.vertexai.macro.AbstractFeature;
import com.vertexai.macro.features.combat.AutoMobKiller.states.AutoMobKillerState;
import com.vertexai.macro.features.combat.AutoMobKiller.states.StartingState;
...
public class AutoMobKiller extends AbstractFeature {
    ...
    public com.vertexai.util.helper.Clock getRogueTimer() { return rogueTimer; }
    ...
    public void start(Collection<String> mobsToKill, String weaponName) {
        start(mobsToKill, weaponName, null, SlayerProfile.GENERIC);
    }
    ...
    public void start(Collection<String> mobsToKill, String weaponName, SlayerProfile slayerProfile) {
        start(mobsToKill, weaponName, null, slayerProfile);
    }

    public void start(Collection<String> mobsToKill, String weaponName, String pickaxeWeaponName, SlayerProfile slayerProfile) {
