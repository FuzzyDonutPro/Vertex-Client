...
import com.vertexai.macro.impl.navigation.GraphEditorFeature;
import com.vertexai.macro.impl.navigation.GraphOverlayRenderer;
...
public class GraphHandler {
    ...
    public void start() {
        ...
        Vertex.executor().execute(this::save);
    }
