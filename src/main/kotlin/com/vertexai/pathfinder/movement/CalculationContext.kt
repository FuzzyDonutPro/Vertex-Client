...
import com.vertexai.pathfinder.costs.ActionCosts
import com.vertexai.pathfinder.helper.BlockStateAccessor
import com.vertexai.pathfinder.helper.player.PlayerContext
...
class CalculationContext(sprintFactor: Double = 0.13, walkFactor: Double = 0.1, sneakFactor: Double = 0.03) {
    ...
    private val generalConfig = VertexMain.config()?.general
