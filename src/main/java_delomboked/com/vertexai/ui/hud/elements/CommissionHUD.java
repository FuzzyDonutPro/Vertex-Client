...
public class CommissionHUD extends TextHud {
    private static final CommissionHUD instance = new CommissionHUD();
    ...
    protected void getLines(List<String> lines, boolean example) {
        ...
        boolean recentlyCompleted = isRunning && lastCompleteAtMs > 0L && (nowMs - lastCompleteAtMs) <= 5000L;
        if (!example) {
    ...
    protected boolean shouldShow() {
        ...
        boolean locationCondition = location == Location.DWARVEN_MINES || location == Location.CRYSTAL_HOLLOWS || location == Location.GLACITE_MINESHAFT;
