package com.vertexai.macro.features.misc.rift;
...
public class VampireSlayerTracker {
    ...
    private static final String[] NAME_START = {"Â§câ˜  Â§4Bloodfiend"};
    private static final Pattern TIMER_PATTERN = Pattern.compile(
            "(?:Â§[8bef]Â§l(ASHEN|CRYSTAL|AURIC|SPIRIT)Â§[8bef] \u2668\\d |Â§4Â§lIMMUNE )?Â§c\\d+:\\d+(?:Â§r)?"
    );
    ...
    private String getItemId(ItemStack stack) {
        ...
        return com.vertexai.util.InventoryUtil.getItemId(stack);
    }
