...
public class PowderMacro extends AbstractMacro {
    ...
    private static final long CHEST_RETRY_COOLDOWN_MS = 20000L;
    private static final long ENVIRONMENT_INVALID_GRACE_MS = 7000L;
    ...
    public boolean updateStatsIfReady() {
        ...
        this.pickaxeAbility = this.pickaxeAbilityRetrievalTask.getResult() == null ? BlockMiner.PickaxeAbility.NONE : this.pickaxeAbilityRetrievalTask.getResult();
    ...
    public boolean ensureMinerRunning() {
        ...
        this.blockMiner.start(targets, this.miningSpeed, this.pickaxeAbility, priorities, Vertex.config().general.miningTool);
        return true;
    }
    ...
    private MineableBlock[] getTargetBlocks() {
        if (Vertex.config().powderMacro.powderType == 1) {
            ...
            return new MineableBlock[] {MineableBlock.GRAY_MITHRIL, MineableBlock.GREEN_MITHRIL, MineableBlock.BLUE_MITHRIL, MineableBlock.TITANIUM};
        }
    ...
    @lombok.Generated
    public static PowderMacro getInstance() {
        return PowderMacro.instance;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public PowderMacroState getCurrentState() {
        return this.currentState;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setCurrentState(final PowderMacroState currentState) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public BlockMiner.PickaxeAbility getPickaxeAbility() {
        return this.pickaxeAbility;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setPickaxeAbility(final BlockMiner.PickaxeAbility pickaxeAbility) {
