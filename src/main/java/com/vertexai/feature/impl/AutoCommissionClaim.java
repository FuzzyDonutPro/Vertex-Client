...
import com.vertexai.util.InventoryUtil.ClickMode;
import com.vertexai.util.InventoryUtil.ClickType;
...
public class AutoCommissionClaim extends AbstractFeature {
    ...
    @Override
    public void start() {
        commClaimMethod = Vertex.config().commission.dwarvenCommission.commClaimMethod;
        if (Vertex.config().general.macroType == 1) {
