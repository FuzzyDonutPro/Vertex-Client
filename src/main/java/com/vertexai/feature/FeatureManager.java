...
public class FeatureManager {
    ...
    public FeatureManager() {
        this.allFeatures.addAll(Arrays.asList(
                ...
                AutoBuffs.getInstance(),
                KillSwitch.getInstance(),
                com.vertexai.feature.impl.AutoMobHunter.getInstance(),
                com.vertexai.feature.impl.AutoFisher.getInstance(),
                com.vertexai.render.WorldESP.getInstance(),
                com.vertexai.feature.impl.AutoPestExchange.getInstance(),
                com.vertexai.feature.impl.PetSwapper.getInstance(),
                com.vertexai.feature.impl.PerformanceMode.getInstance(),
                com.vertexai.feature.impl.LagDetector.getInstance(),
                com.vertexai.feature.impl.Humanizer.getInstance(),
                com.vertexai.feature.impl.StaffDetector.getInstance(),
                com.vertexai.feature.impl.BreakScheduler.getInstance(),
                com.vertexai.feature.impl.AutoResponder.getInstance(),
                com.vertexai.feature.impl.AutoWarp.getInstance(),
                com.vertexai.feature.impl.CaptchaDetector.getInstance(),
                com.vertexai.feature.impl.RancherSpeedSetter.getInstance(),
                com.vertexai.feature.impl.WardrobeSwapper.getInstance(),
                com.vertexai.feature.impl.SackManager.getInstance(),
                com.vertexai.feature.impl.RefuelEngineSwapper.getInstance(),
                com.vertexai.feature.impl.SlayerQoL.SlayerQoL.getInstance(),
                com.vertexai.feature.impl.RouteAutoRecorder.getInstance(),
                com.vertexai.feature.impl.FastBreak.getInstance(),
