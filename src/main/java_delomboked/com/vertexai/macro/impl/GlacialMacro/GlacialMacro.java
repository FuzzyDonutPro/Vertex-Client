...
public class GlacialMacro extends AbstractMacro {
    ...
    public Pair<GlaciteVeins, RouteWaypoint> findBestVein() {
        ...
        return possibleVeins.stream().min(Comparator.comparingDouble(pair -> GraphHandler.instance.distance(getName(), PlayerUtil.getBlockStandingOn(), pair.second()))).orElse(null);
    }
    ...
    @lombok.Generated
    public static GlacialMacro getInstance() {
        return GlacialMacro.instance;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ArrayList<GlaciteVeins> getTypeToMine() {
        return this.typeToMine;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Map<Pair<GlaciteVeins, RouteWaypoint>, Long> getPreviousVeins() {
        return this.previousVeins;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setCurrentState(final GlacialMacroState currentState) {
        this.currentState = currentState;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public GlacialMacroState getCurrentState() {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setCurrentVein(final Pair<GlaciteVeins, RouteWaypoint> currentVein) {
        this.currentVein = currentVein;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Pair<GlaciteVeins, RouteWaypoint> getCurrentVein() {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public int getCommissionCounter() {
