...
public class TablistUtil {
    ...
    public static void update() {
        ...
        try {
            Component header = net.minecraft.network.chat.Component.empty(); // TODO: Add accessor
            if (header != null) {
        ...
        try {
            Component footer = net.minecraft.network.chat.Component.empty(); // TODO: Add accessor
            if (footer != null) {
