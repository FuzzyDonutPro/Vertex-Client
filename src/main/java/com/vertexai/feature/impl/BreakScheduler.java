...
/**
 * BreakScheduler — Takes natural 20–45 second "stretching/drink" breaks
 * every 35–50 minutes of continuous macroing.
 */
public class BreakScheduler extends AbstractFeature {
    ...
    protected void onTick() {
        ...
        if (sessionClock.passed() && !takingBreak) {
            takingBreak = true;
            int breakDurationSec = 20 + random.nextInt(25); // 20–45s break
    ...
    private void scheduleNextBreak() {
        nextBreakDelay = (35 + random.nextInt(15)) * 60 * 1000L; // 35–50 minutes
