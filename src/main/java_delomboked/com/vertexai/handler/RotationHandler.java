...
public class RotationHandler {
    ...
    private static final float MAX_YAW_SPEED_DEG_PER_SEC = 240.0F;
    private static final float MAX_PITCH_SPEED_DEG_PER_SEC = 180.0F;
    private static final float NEAR_SLOWDOWN_DEG = 10.0F;
    ...
    private void initOvershoot(Angle change) {
        ...
        if (Math.abs(change.getYaw()) < 8.0F && Math.abs(change.getPitch()) < 6.0F) {
            return;
        }
