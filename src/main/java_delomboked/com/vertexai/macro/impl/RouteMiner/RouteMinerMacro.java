...
public class RouteMinerMacro extends AbstractMacro {
    ...
    public void onEnable() {
        ...
        if (waypointCount == 0) {
            error("Selected route \'" + routeHandler.getSelectedRouteName() + "\' has no waypoints. Enable RouteBuilder and add points with P/I or /rb add <walk|etherwarp|mine>.");
    ...
    @lombok.Generated
    public static RouteMinerMacro getInstance() {
        return RouteMinerMacro.instance;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setCurrentState(final RouteMinerMacroState currentState) {
        this.currentState = currentState;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public RouteMinerMacroState getCurrentState() {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setRouteIndex(final int routeIndex) {
